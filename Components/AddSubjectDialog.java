...
public class AddSubjectDialog extends JDialog {
    ...
    private void attemptCreateSubject() {
        ...
        if (sum != 0 && sum != 100) {
            int resp = JOptionPane.showConfirmDialog(this, "The total rubric percentage is " + sum
                    + "%. Are you sure you want to proceed? (It should be 100% for automatic grade calculation)",
